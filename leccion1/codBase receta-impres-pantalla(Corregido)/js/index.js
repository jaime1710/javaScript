...
document.getElementById("boton_receta1").addEventListener("click", function() {
    ...
    document.getElementById("mostrar_receta1").innerHTML = "- Adicionar las " + unidadesClaraDeHuevo + " " + ingredientes[0] + "en bol y batir con los " + gramosazucar + " gramos de " + ingredientes[1] + "<br>" + "<br>"
    + "- Adicionar los " + gramoslecheCondensada + " gramos de " + ingredientes[2] + " y batir bien" + "<br>" + "<br>"
    + "- Adicionar el zumo de " + unidadeslimon + " " + ingredientes[4] + " y " + sobresGelatina + " sobre de " + ingredientes[3] + "hidratada en el agua tibia" + "<br>" + "<br>"
    + "- Deposita la mescla en el moldes individuales y colocalos a refrigerar";
})
document.getElementById("boton_receta2").addEventListener("click", function() {
    ...
    document.getElementById("mostrar_receta2").innerHTML = "- Verter las " + onzasGine + "onzas de " + ingredientes[0] + " en una coctelera" + "<br>" + "<br>"
    + "- Añadir " + onzasVermouth + " onzas de " + ingredientes[1] + "<br>" + "<br>"
    + "- Servir en una copa tipo Martini y añadir " + unidadesAceituna + " " + ingredientes[2];
})
